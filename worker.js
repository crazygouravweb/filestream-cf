...
const BOT_SECRET = "123456789"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 7650437993; // Insert your telegram account id.
const BOT_CHANNEL = -1002383409642; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "crazy"; // Insert a powerful secret text and keep it safe.
